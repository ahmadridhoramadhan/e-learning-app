<x-join-room-layout :title="$room->name" :questions="$questions" :roomId="$room->id" :$maxTime>
    <div class="border p-2 shadow-md bg-slate-50 min-h-52 text-lg select-none">
    ...
    <div id="container-answer" class="flex flex-col gap-4 mt-8 select-none">
        <template x-for="answer in questions[currentIndex].answers" :key="answer.id">
            <label class="w-full relative">
                ...
                <div class="w-full py-2 bg-slate-100 border px-2 transition-all peer-checked:border-2 peer-checked:bg-cyan-100 peer-checked:border-cyan-700 peer-checked:text-cyan-800"
