...
<body class="flex flex-col min-h-screen dark:bg-slate-900 dark:text-white">
    ...
    <aside id="logo-sidebar"
                ...
                @if (Auth::user()->is_admin)
                    ...
                    <li>
                        <a href="{{ route('admin.rooms') }}"
                            ...
                            <span class="flex-1 ms-3 whitespace-nowrap">My Rooms</span>
                    ...
                    <li>
                        <a href="{{ route('user.room.search') }}"
                            ...
                            <span class="flex-1 ms-3 whitespace-nowrap">cari Rooms</span>
                        </a>
                    </li>
                @else
                    <li>
                        <a href="{{ route('user.dashboard') }}"
                            class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group {{ Route::is('user.dashboard') ? 'dark:bg-slate-900 ' : '' }}">
                            <svg class="w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                                aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                                viewBox="0 0 22 21">
                                <path
                    ...
                    <li>
                        <a href="{{ route('user.histories') }}"
                            class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group {{ Route::is('user.histories') ? 'dark:bg-slate-900 ' : '' }}">
                    ...
                    <li>
                        <a href="{{ route('user.invitations') }}"
                            class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group {{ Route::is('user.invitations') ? 'dark:bg-slate-900 ' : '' }}">
                            ...
                            <span class="ms-3">Invitations</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('user.room.search') }}"
        ...
        <div class="px-1 py-2 text-sm dark:text-gray-300 border-t-2 dark:border-gray-600">
            <div class="text-xs">
                <div>kelompok 5 - 2024</div>
                <ul class="list-decimal list-outside ml-3 mt-1">
                    <li>Ahmad Ridho Ramadhan</li>
                    <li>Muhammad Yusuf</li>
                </ul>
            </div>
        </div>
    </aside>
